...
the data set must be found at this link:
https://drive.google.com/drive/folders/193LYvOr5Z0LAmVjv1kSWkkdUB2uaSAS1

the label set must be found at this link: 
https://drive.google.com/drive/folders/19ymfHkcEQnW6-iI1KPHfhs8zn0D7KVYX

Cmake needed.

This project, receives as an input different sequences of frames, and predicts the position of the moving object across the different frames; to measure the correctness of the idea, it's used the median IoU between my detections and the results contained in a label set. 
...
- motion filtering, because we want to consider only points with a significant movement;
